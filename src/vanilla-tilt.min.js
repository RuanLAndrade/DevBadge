let VanillaTilt=function(){
  ...
  {if(!(e instanceof Node))
    ...
    this.reverse=this.settings.reverse?-1:1,this.glare=t.isSettingTrue(this.settings.glare),
  ...
  getElementListener(){
    ...
    if("string"==typeof this.settings["mouse-event-element"]){
      ...
      instanceof Node?this.settings["mouse-event-element"]:this.element}
      ...
      onDeviceOrientation(t){
        ...
        this.updateElementPosition(),
          this.gyroscopeSamples>0&&(
            this.lastgammazero=this.gammazero,this.lastbetazero=this.betazero,null===this.gammazero?
      ...
      reset(){
        ...
        this.element&&this.element.style&&(this.element.style.transform=`perspective(${
      ...
      updateInitialPosition(){
        ...
        let t=this.settings.scale;this.settings.scale=1,
        this.update(),this.settings.scale=t,
        this.resetGlare()
      }
      
      getValues(){
        let t,e;
        return this.fullPageListening?(t=this.event.clientX/this.clientWidth,e=this.event.clientY/this.clientHeight)
        ...
        e=Math.min(Math.max(e,0),1),
        {
          ...
          percentageX:100*t,percentageY:100*e,angle:Math.atan2(this.event.clientX-(this.left+this.width/2),
      ...
      updateElementPosition(){
        ...
        update(){
          ...
          this.glare&&(this.glareElement.style.transform=`rotate(${t.angle}deg)
          translate(-50%, -50%)`,
        ...
        prepareGlare(){
          ...
          this.glarePrerender||(Object.assign(this.glareElementWrapper.style,
            ...
            Object.assign(this.glareElement.style,{position:"absolute",
            top:"50%",
            left:"50%",
            "pointer-events":"none",
            "background-image":"linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba(255,255,255,1) 100%)",
            transform:"rotate(180deg) translate(-50%, -50%)","transform-origin":"0% 0%",opacity:"0"}),
        ...
        extendSettings(t){
          let e={reverse:!1,max:15,startX:0,startY:0,perspective:1e3,easing:"cubic-bezier(.03,.98,.52,.99)",
          scale:1,
          speed:300,
          transition:!0,
          axis:null,
          glare:!1,"max-glare":1,"glare-prerender":!1,"full-page-listening":!1,"mouse-event-element":null,
          reset:!0,gyroscope:!0,
